...
void setup() {
    ...
    ServoSTR.attach(PIN_STR, minimumSteeringValue, maximumSteeringValue); // Map values to 1k to 2k
    ServoTHR.attach(PIN_THR, minimumThrottleValue, maximumThrottleValue);
    ...
    if (Serial.available()) {
        ...
        while (command != 0) {
            ...
            case CMD_STR:
                ...
                if( theDataPtr->str > maximumSteeringValue || theDataPtr->str < minimumSteeringValue ){
            ...
            case CMD_THR:
                ...
                if( theDataPtr->thr > maximumThrottleValue || theDataPtr->thr < minimumThrottleValue ){
